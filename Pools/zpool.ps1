...
$Zpool_Request = [PSCustomObject]@{} 
 ...
 try { 
     $Zpool_Request = Invoke-RestMethod "http://zpool.ca/api/status" -UseBasicParsing -TimeoutSec 10 -ErrorAction Stop
     $ZpoolCoins_Request = Invoke-RestMethod "http://zpool.ca/api/currencies" -UseBasicParsing -TimeoutSec 10 -ErrorAction Stop 
 } 
 catch { 
