...
$Name = Get-Item $MyInvocation.MyCommand.Path | Select-Object -ExpandProperty BaseName 
 ...
 try { 
     $ahashpool_Request = Invoke-RestMethod "https://ahashpool.com/api/status" -UseBasicParsing -TimeoutSec 10 -ErrorAction Stop 
     $ahashpoolCoins_Request = Invoke-RestMethod "http://ahashpool.com/api/currencies" -UseBasicParsing -TimeoutSec 20 -ErrorAction Stop
 } 
 catch { 
