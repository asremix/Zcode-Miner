...
try { 
$phiphipool_Request = Invoke-RestMethod "http://phi-phi-pool.com/api/status" -UseBasicParsing -TimeoutSec 10 -ErrorAction Stop 
$phiphipoolCoins_Request = Invoke-RestMethod "http://phi-phi-pool.com/api/currencies" -UseBasicParsing -TimeoutSec 10 -ErrorAction Stop 
} 
catch { 
